...
export const allRooms: Room[] = [
  ...
  { x: 124, y: 323, type: "boss", name: 'Hippogryph' },
  ...
  {
    x: 246, y: 122, type: "combat", name: 'Door of Loathing',
  ...
  { x: 547, y: 322, type: "combat", name: 'Crystal Man', label: 'right10' },
  ...
  { x: 697, y: 477, type: "combat", name: 'Enantiomer' },
  { x: 721, y: 477, type: "none" },
  { x: 721, y: 426, type: "combat", name: 'Hopanoids' },
  { x: 676, y: 426, type: "combat", name: 'Tosyl Rose' },
  { x: 676, y: 380, type: "combat", name: 'Food Mimic' },
  { x: 721, y: 380, type: "combat", name: 'Unwelcoming Glade' },
  { x: 721, y: 343, type: "none" },
  { x: 666, y: 343, type: "none" },
  { x: 666, y: 309, type: "combat", name: 'The King\'s Armor' },
  { x: 666, y: 252, type: "combat", name: 'Scaffold Sorcery' },
  { x: 698, y: 252, type: "combat", name: 'Corridor of Illusions' },
  { x: 698, y: 309, type: "none" },
  { x: 733, y: 309, type: "rescue", name: "Smiling Pilot" },
  { x: 733, y: 252, type: "combat", name: 'Hiber Conduit' },
  ...
  { x: 607, y: 76, type: "combat", name: 'Lior the Weaver' },
  { x: 607, y: 112, type: "none" },
  { x: 628, y: 112, type: "none" },
  { x: 628, y: 121, type: "combat", name: 'Golden Chest' },
  { x: 639, y: 121, type: "none" },
  { x: 639, y: 167, type: "none" },
  { x: 628, y: 167, type: "combat", name: 'Power Crystal' },
  { x: 628, y: 177, type: "none" },
  { x: 526, y: 177, type: "rescue", name: 'Zaktar Kadoque' },
  { x: 526, y: 142, type: "none" },
  { x: 540, y: 142, type: "combat", name: 'Gnollish Ambassador' },
  { x: 540, y: 69, type: "combat", name: 'Wands from the Depths' },
  { x: 503, y: 69, type: "combat", name: 'Decay Manifest' },
