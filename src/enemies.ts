...
export const allEnemies: Enemy[] = [
  ...
  { name: "Dark Lord", health: 10_000, armor: 100, rewards: { gold: 10, fruit: 10 } },
  ...
  { name: "Crystal Man", health: 600, dodge: 0.00001, rewards: { gold: 2000, fruit: 500 }, weaknesses: ["blunt", "ice"] },
  ...
  { name: "Dragonfly Agaric", health: 600_000, rewards: { gold: 20, fruit: 30 }, immune: ["poison"], weaknesses: ["fire", "left"] },
  { name: "Artifact Seeker", health: 70_000, dodge: 2, rewards: { gold: 2000, fruit: 20 }, weaknesses: ["ice", "fire", "water"] },
  ...
  { name: "Tombstone of the Forgotten", health: 29_000_000, armor: 10_000, rewards: { gold: 2000, fruit: 125 }, weaknesses: ["front", "light"] },
