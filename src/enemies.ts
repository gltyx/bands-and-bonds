...
export const allEnemies: Enemy[] = [
  ...
  { name: "Chago", health: 140_000, armor: 25_000, rewards: { fruit: 120 }, dodge: 0.01, weaknesses: ["blunt", "water"] },
  ...
  { name: "Landas Wizard", health: 320_000, dodge: 0.01, rewards: { gold: 200, fruit: 100 }, weaknesses: ["water", "back"] },
  { name: "Crystal Man", health: 600, dodge: 0.001, rewards: { gold: 2000, fruit: 500 }, weaknesses: ["blunt", "ice"] },
  ...
  { name: "Scaffold Sorcery", health: 20_000, armor: 1000, rewards: { gold: 100, fruit: 12 }, weaknesses: ["fire", "sharp"] },
  ...
  { name: "Unwelcoming Glade", health: 2_400_000, rewards: { gold: 100, fruit: 200 }, weaknesses: ["fire", "sharp"] },
  { name: "Food Mimic", health: 3_100_000, armor: 10, rewards: { gold: 100, fruit: 250 }, weaknesses: ["blunt"] },
  { name: "Frog Assassin", health: 1_050_000, dodge: 0.1, rewards: { gold: 1, fruit: 1 } },
  { name: "Enantiomers", count: 2, health: 1_000_000, armor: 9_100, dodge: 0.1, rewards: { fruit: 300 }, weaknesses: ["fire"] },
  { name: "Gnollish Ambassador", health: 750_000, armor: 10, dodge: 0.05, rewards: { gold: 200, fruit: 150 }, weaknesses: ["fire", "right"] },
  { name: "Web of Power", health: 10_000_000, rewards: { gold: 2_000, fruit: 100 }, weaknesses: ["water", "left"] },
  { name: "Tombstone of the Forgotten", health: 29_000_000, armor: 10_000, rewards: { gold: 2000, fruit: 250 }, weaknesses: ["front", "light"] },
  { name: "Hippogryph", health: 80_000_000, regen: 10_000, rewards: { gold: 12_000, fruit: 400 }, weaknesses: ["fire", "left"] },
  { name: "The King's Armor", health: 60_000_000, armor: 100_000, rewards: { gold: 8_000 }, immune: ["sharp"], weaknesses: [] },
  { name: "Corridor of Illusions", health: 6_000_000, dodge: 0.01, rewards: { gold: 6_000, fruit: 600 }, weaknesses: ["light"] },
  ...
  { name: "The Final Warden", dodge: 0.001, health: 999_000_000, regen: 600_000, rewards: { gold: 15_000, fruit: 5000 }, immune: ["fire"], weaknesses: ["light", "ice"] },
  {
    name: "Skelemasterion", health: 1_000_000_000_000_000, armor: 1_000_000_000_000, regen: 1_000_000_000_000, ethereal: true,
    rewards: { gold: 1_000_000_000, fruit: 1_000_000_000 }, passiveEffects: ["This dungeon is barely strong enough to contain the invincible Skelemasterion."]
  },
];
