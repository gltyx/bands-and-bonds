...
export const allEnemies: Enemy[] = [
  ...
  { name: "Glass Dragon", health: 100_000, rewards: { gold: 100, fruit: 10 } },
  ...
  { name: "Lior the Weaver", health: 1000, armor: 1, rewards: { gold: 2_000, fruit: 100 }, weaknesses: ["sharp", "fire"] },
  { name: "Skeletron", health: 100_000, armor: 200, rewards: { gold: 1, fruit: 1 }, weaknesses: ["blunt", "back"], },
  ...
  { name: "Door of Loathing", health: 1000, armor: 10_000, rewards: { gold: 200 }, weaknesses: ["blunt", "ice"] },
  { name: "Zakatrixos", health: 1_000_000, ethereal: true, rewards: { gold: 1, fruit: 1 } },
  { name: "Wands from the Depths", health: 600_000, armor: 60, rewards: { gold: 200, fruit: 40 }, weaknesses: ["ice"] },
  { name: "Skyrmions", health: 100, ethereal: true, count: 107, rewards: { gold: 1, fruit: 1 }, weaknesses: ["back"] },
  { name: "Defensive Installation", health: 1_000, armor: 1_000, rewards: { gold: 200 }, weaknesses: ["blunt", "front"] },
  { name: "Tenebra", health: 30_000, ethereal: true, rewards: { gold: 1, fruit: 1 }, weaknesses: ["fire", "front"] },
  { name: "Landas Wizard", health: 100_000, dodge: 1, rewards: { gold: 200, fruit: 100 }, weaknesses: ["water", "back"] },
  ...
  { name: "Frozen Centurion", health: 200, dodge: 10, rewards: { gold: 20, fruit: 5 }, weaknesses: ["fire", "front"] },
  { name: "Trollish Maiden", health: 1000, regen: 10, rewards: { gold: 8, fruit: 10 }, passiveEffects: ["The Trollish Maiden heals quickly."] },
  { name: "Dryfin Carp", health: 10_000, rewards: { gold: 100, fruit: 10 }, weaknesses: ["water", "back"] },
  { name: "Scaffold Sorcery", health: 1000, armor: 100, rewards: { gold: 100, fruit: 12 }, weaknesses: ["fire", "axe"] },
  { name: "Lost Swimmer", health: 1_000, armor: 1_000, rewards: { fruit: 20 }, weaknesses: ["ice"] },

  { name: "Geckalog", health: 80_000, rewards: { gold: 80, fruit: 15 }, weaknesses: ["ice", "left"] },
  { name: "Jaw Maw Maw", health: 60_000, regen: 60, rewards: { gold: 60, fruit: 16 } },
  { name: "Decay Manifest", health: 120_000, rewards: { gold: 20, fruit: 19 }, weaknesses: ["fire", "right"] },
  { name: "Striped Horror", health: 1_000_000, rewards: { gold: 10, fruit: 10 } },
  { name: "Dragonfly Agaric", health: 6_000_000, rewards: { gold: 20, fruit: 40 }, weaknesses: ["fire", "left"] },
  { name: "Artifact Seeker", health: 70_000, dodge: 0.2, rewards: { gold: 2000, fruit: 60 }, weaknesses: ["ice", "fire", "water"] },
  { name: "Golden Chest", health: 1, armor: 100_000, rewards: { gold: 2_000_000 }, weaknesses: ["blunt"] },
  { name: "King of Tadpoles", health: 11_500_000, rewards: { gold: 100, fruit: 80 } },
  { name: "Hopanoids", count: 10, health: 50_000, armor: 10_000, dodge: 0.5, rewards: { fruit: 200 }, weaknesses: ["fire"] },
  { name: "Tosyl Rose", health: 860_000, armor: 400_000, rewards: { gold: 100, fruit: 200 }, weaknesses: ["fire", "right"] },
  { name: "Sullen Bearer", health: 1_000, armor: 1_000, rewards: { gold: 200 }, weaknesses: ["back"] },
  ...
  { name: "Frog Assassin", health: 1_000_000, rewards: { gold: 1, fruit: 1 } },
  { name: "Enantiomer", health: 1000, armor: 10_000, dodge: 0.9, rewards: { fruit: 200 }, weaknesses: ["fire"] },
  ...
  { name: "Tombstone of the Forgotten", health: 1000, armor: 10_000, rewards: { gold: 2000, fruit: 100 }, weaknesses: ["front", "magic"] },
  { name: "Hippogryph", health: 600, rewards: { gold: 20, fruit: 40 }, weaknesses: ["fire", "left"] },
  { name: "The King's Armor", health: 100, armor: 100_000, rewards: { gold: 100, fruit: 200 }, weaknesses: [] },
  ...
  { name: "The Final Warden", dodge: 0.1, health: 1_000_000, rewards: { gold: 200, fruit: 100 }, weaknesses: ["holy", "ice"] },
  { name: "Skelemasterion", health: 1_000_000_000, armor: 1_000_000_000, regen: 1_000_000, ethereal: true, rewards: { gold: 1_000_000_000, fruit: 1_000_000_000 } },
];
...
const enemyAbilities: Record<string, Ability> = {
  ...
  "Bandlings": { name: "Swarm", duration: 5, damage: 1, description: "A swarm of tiny creatures." },
  "Dead Gladiator": { name: "Revenge", duration: 1, damage: 1, description: "A vengeful spirit attacks." },
  "Lobster Daddy": { name: "Claw Smash", duration: 1, damage: 1, description: "A powerful claw attack." },
  "Will-o-Wasp": { name: "Sting", duration: 1, damage: 1, description: "A quick and painful sting." },
  "The Shroud": { name: "Cloak of Darkness", duration: 1, damage: 1, description: "Envelops the enemy in darkness." },
  "Dark Lord": { name: "Shadow Strike", duration: 1, damage: 1, description: "A strike from the shadows.", tags: ['dark'] },
  "Clockomancer": {
  ...
  "Enantiomer": { name: "", duration: 1, damage: 1, description: "" },
...
for (const e of allEnemies) {
  ...
  e.abilities = enemyAbilities[e.name]?.name ? [enemyAbilities[e.name]] : [];
